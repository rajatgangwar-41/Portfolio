...
import { rajat } from "../assets"
import { resumeURL, socialMedia, text } from "../constants"
import { styles } from "../styles"
import { ChatBot, SocialMedia } from "./index"
import { fadeIn } from "../utils/motion"

const Hero = SectionWrapper(() => {
  return (
    <>
      <div className="relative top-[120px] text-white flex flex-col lg:flex-row lg:justify-between items-center">
        <motion.div
        ...
        >
          ...
          <ul className="list-none bg-primary mt-2 gap-5 flex flex-wrap justify-between">
            {socialMedia.map((ele, index) => (
              <SocialMedia key={ele.id} index={index} {...ele} />
            ))}
          </ul>
        </motion.div>
        <motion.div
          variants={fadeIn("left", "tween", 0.1, 1)}
          className="flex justify-center mx-5 mt-15 max-w-120 max-h-150 rounded-xl"
        >
          <img src={rajat} alt="rajat" className="rounded-xl object-contain" />
        </motion.div>
        {/* <ChatBot /> */}
      </div>
      <hr className="mt-40 mx-5 border-b-[2px] border-white" />
    </>
  )
}, "home")
